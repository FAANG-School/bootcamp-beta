...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        for (Map.Entry<String, House> entry: _vesterosHouse.entrySet()) {
            System.out.println("Название дома: " + entry.getKey() + ", Описание дома: " + entry.getValue().name + ", герб: " + entry.getValue().sigil);
        }
    }
    ...
    public static void searchInfoHouse(String key){
        ...
        System.out.println("Дом: " + house.name + ", герб: " + house.sigil);
    }
}
