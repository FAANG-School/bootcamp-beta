...
public class Task_2 {
    public static void main(String[] args) {
        ...
        var alicesAdventures = AddNewBook(library, "Alice's Adventures in Wonderland", "Lewis Carroll",
        ...
        FindBook(library, alicesAdventures.getTitle(), alicesAdventures.getAuthor(), alicesAdventures.getYear());
        RemoveBook(library, alicesAdventures.getTitle(), alicesAdventures.getAuthor(), alicesAdventures.getYear());
        System.out.println("\n");
        PrintLibraryInfo(library);
    }
